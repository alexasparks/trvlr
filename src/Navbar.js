  ...
  return(
    ...
    <ul>
      <li>
        <Link to='/worldmap'>
        <img
        className='icon' src='https://cdn.iconscout.com/public/images/icon/free/png-512/earth-global-globe-international-map-planet-world-31f086acb2c23d8b-512x512.png'/>
        </Link>
      </li>
      <li className='icon'>
      <Link
